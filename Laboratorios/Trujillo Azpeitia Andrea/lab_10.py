...
expresándolo en horas y minutos. Las horas van de 0 a 23 y los minutos de 0 a 59. El resultado debe ser mostrado 
en la consola.
...
mins_totales = hour * 60 + mins
mins_totales += dura
hora_final = mins_totales // 60 
hora_final %= 24
minutos_final = mins_totales % 60
